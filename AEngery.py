...
def ReadAngle(filename):
    ...
    f.close()
    adata = sorted(adata, key=lambda adata: adata[0]) # sort data
    return adata
...
# Data Input
output_S1 = ReadAngle('pe0.L360_K20000_A75_T0_V0.1_mkT_cy_Tn0_S1_a_r0(1)')
output_S = ReadAngle('pe0.L154_K20000_A75_T1_V0.1_mkT_cy_Tn_S72380_a_r0(4)')
